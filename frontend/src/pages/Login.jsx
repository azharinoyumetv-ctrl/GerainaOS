    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex flex-col justify-between w-1/2 p-12 relative bg-grain"
        ...
        <div className="text-white space-y-4 max-w-md">
          <p className="label-tiny" style={{ color: "hsl(9,65%,75%)" }}>UMKM Indonesia</p>
          <h2 className="font-display text-4xl font-bold leading-tight">
            POS yang ringan,<br /> laporan yang serius.
          </h2>
          <p className="text-white/70">Kelola toko, kasir, stok, dan pembayaran dari satu dashboard yang dibangun untuk pemilik UMKM.</p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <form onSubmit={submit} className="w-full max-w-sm space-y-6" data-testid="login-form">
          <div>
            ...
            <p className="text-sm text-[hsl(var(--muted))] mt-1">Selamat datang kembali, kasir.</p>
          </div>
